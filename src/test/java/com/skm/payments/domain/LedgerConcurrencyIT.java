...
/**
 * The headline correctness test: a wallet funded for 50 units, hit by 100 concurrent 1-unit debits,
 * must end with exactly 50 successes, 50 insufficient-funds rejections, a final balance of 0, and
 * must never go negative. Proves SELECT ... FOR UPDATE + the non-negative guard prevent oversell.
 */
